...
image::images/app/InstructionPanel.png[Instructions, 100%]
...
Mit dem Button “Reset state” (oben in orange) kann ein Benutzer oder eine Benutzering den Stand der Applikation zurücksetzen. Nach Klick auf den Button werden alle Objektinstanzen gelöscht und somit nicht mehr angezeigt.

*Interaktion mit der Applikation*

Mit dem Textfeld links unten (oben in rot) kann ein Benutzer oder eine Benutzerin Javacode an die JShell übermitteln. Es können z.B. neue Objektinstanzen erstellt oder Methoden auf Referenzen ausgeführt werden.
...
Eine neu erstellte Objektinstanz wird Links neben dem Klassendiagramm angezeigt. Dabei wird der Referenztyp umrahmt und zeigt so die Sicht an, die momentan auf die ObjektInstanz möglich ist. Methoden ausserhalb der Referenzsicht, sind dementsprechend nicht ausführbar.
...
image::images/app/App.png[App, 100%]

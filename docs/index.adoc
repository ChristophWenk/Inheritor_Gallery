...
Lösungen gefunden wurden, um Instanzen eines Java Programms visuell verständlich darzustellen.

Gemäss den Ergebnissen der durchgeführten Usability Test und der Interviews konnte eine Darstellungsart entworfen werden,
...
ob diese Funktionalität umgesetzt werden soll oder besser die Anforderungen besser neu priorisiert werden müssen.
...
Falls doch einmal unsauberer Code gepushed wurde, so konnte dies mit Hilfe von Travis CI schnell ausfindig gemacht werden.

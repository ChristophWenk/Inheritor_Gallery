...
|NF-1
|Die Applikation soll mit jlink lauffähig sein.
...
|NF-4
|Die Applikation soll eigenständig ausgeführt werden können.
...
=== Zielgruppe
Zielgruppe sind Programmieranfänger auf Sekundär- oder Tertiärstufe.

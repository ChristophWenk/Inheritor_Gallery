...
:sourcedir: ../IntroFX-core/src/main/java
:sourcedirdemo: ../IntroFX-demo/src/main/java
:dir-source-core: ../introfx-core/src/main/java/com/dlsc/introfx


==== Citate
[source,java]
----
include::{dir-source-core}/Hello.java[]
----
